...
export default function HeroHeader({PicTest,TitleHero,descriptionHero}:{PicTest:string,TitleHero:string,descriptionHero:string}){
    return(
    <div className="w-full relative flex flex-col gap-10 items-center md:px-0 px-4">
        ...
        <Image src={PicTest} width={1115} height={458} loading="eager" alt="" className="object-cover w-fill h-114.5 rounded-[20px]"  />
    </div>
    )
}